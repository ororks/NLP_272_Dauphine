...
parser.add_argument('--max_len', type=int, default=20000, help='Maximum length for padded sequences')
parser.add_argument('--n_components', type=int, default=20, help='Number of components for PCA')
parser.add_argument('--n_estimators', type=int, default=500, help='Classifier estimators')
